...
namespace ProjectZ
{
    public static class ByteArray
    {
        ...
        public static void SetUInt64(this byte[] arr, int offset, ulong value, bool bigEndian = false)
        {
            ...
            arr[offset + 7] = (byte)((value & 0xFF00000000000000) >> 56);
        }
        ...
        {
            ulong ret = ((ulong)arr[offset + 0] | ((ulong)arr[offset + 1] << 8) |
                         ((ulong)arr[offset + 2] << 16) | ((ulong)arr[offset + 3] << 24) |
                         ((ulong)arr[offset + 4] << 32) | ((ulong)arr[offset + 5] << 40) |
                         ((ulong)arr[offset + 6] << 48) | ((ulong)arr[offset + 7] << 56));
